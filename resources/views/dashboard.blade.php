                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 gap-4 px-4 mt-8 sm:grid-cols-4 sm:px-8">
                        ...
                        <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
                            ...
                            <div class="px-4 text-gray-700">
                                <h3 class="text-sm tracking-wider">Total Adopted Plants</h3>
                                <p class="text-3xl">{{$plantcount}}</p>
                            </div>
                        </div>
                        <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
                            ...
                            <div class="px-4 text-gray-700">
                                <h3 class="text-sm tracking-wider">Total Unique Plants</h3>
                                <p class="text-3xl">{{$plantdistinct}}</p>
                            </div>
                        </div>
                        <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
                            <div class="p-4 bg-red-400"><svg xmlns="http://www.w3.org/2000/svg"
                                    class="h-12 w-12 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
